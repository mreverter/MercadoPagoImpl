...
public class CardDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mCardNumber.setText("5031755734530604");
        this.mCardHolderName.setText("Apro");
        this.mSecurityCode.setText("100");
        this.mExpiryMonth.setText("1");
        this.mExpiryYear.setText("17");
        this.mIdentificationNumber.setText("34546783");
    ...
    private void createTokenAsync() {
        ...
        mMercadoPago.createToken(mCardToken, new Callback<Token>() {
            ...
            public void success(Token token, Response response) {
                startInstallmentsActivity(token);
            }
    ...
    private void startInstallmentsActivity(Token token) {
        Intent intent = new Intent(CardDataActivity.this, InstallmentsActivity.class);
        intent.putExtras(getIntent());
        intent.putExtra("token", JsonUtil.getInstance().toJson(token));
        intent.putExtra("bin", this.getBinFromCardToken(mCardToken));
    ...
    private String getBinFromCardToken(CardToken cardToken) {
